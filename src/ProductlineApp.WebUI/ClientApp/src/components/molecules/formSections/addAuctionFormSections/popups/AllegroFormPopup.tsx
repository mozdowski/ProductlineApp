...
const AllegroFormPopup = ({ openAllegroPopup, closeAllegroPopup, errors }: {
    ...
    return (
        <div className="overlayAllegroPopup">
            <div className="allegroPopup" onClick={(e) => { e.stopPropagation() }}>
                ...
                <div className="allegroPopupFormInputs">
                    <form>
                        <div className='firstLineAllegroAuctionInputs'>
                            <ProductNameInput value={""} onChange={function (name: string, value: string): void {
                                throw new Error('Function not implemented.');
                            }} error={errors} disabled={false} />
                            <SelectProductAllegroIdeas />
                        </div>
                        <div className='secondLineAllegroAuctionInputs'>

                        </div>
                        <div className='thirdLineAllegroAuctionInputs'>

                        </div>
                        <div className='fourthLineAllegroAuctionInputs'>
