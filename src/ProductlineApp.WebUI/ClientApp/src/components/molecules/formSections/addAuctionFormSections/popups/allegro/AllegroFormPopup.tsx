      ...
      >
        <div className="allegroPopupSectionLabel">
          ...
          {currentPage === PopupPages.ProductSelect && (
            <p className="allegroPopUpInfoText">Wybierz produkt z katalogu Allegro</p>
          )}
          {currentPage === PopupPages.ParametersSet && (
            <p className="allegroPopUpInfoText">Dostosuj parametry produktu</p>
          )}
          {currentPage === PopupPages.ListingDetails && (
            <p className="allegroPopUpInfoText">Dostosuj parametry oferty</p>
          )}
        </div>
