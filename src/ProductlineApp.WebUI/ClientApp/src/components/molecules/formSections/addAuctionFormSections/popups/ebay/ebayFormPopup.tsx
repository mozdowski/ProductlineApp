      ...
      >
        <div className="ebayPopupSectionLabel">
          ...
          {currentPage === PopupPages.Category && (
            <p className="ebayPopUpInfoText">Wybierz kategorie z katalogu Ebay</p>
          )}
          {currentPage === PopupPages.ParametersSet && (
            <p className="ebayPopUpInfoText">Dostosuj parametry produktu</p>
          )}
          {currentPage === PopupPages.ListingDetails && (
            <p className="ebayPopUpInfoText">Dostosuj parametry oferty</p>
          )}
        </div>
        {currentPage === PopupPages.Category && (
