...
export default function AuctionsTable({ auctionRecords, isSelectedTypeAuctions, handleClickTypeAuctionsButton }: { auctionRecords: AuctionsRecord[], isSelectedTypeAuctions: any, handleClickTypeAuctionsButton: any }) {

    return (
        <>
            <AuctionsHederActions isSelectedTypeAuctions={isSelectedTypeAuctions} handleClickTypeAuctionsButton={handleClickTypeAuctionsButton} />
