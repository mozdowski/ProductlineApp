...
export default function OrdersTable({ orderRecords, isSelectedTypeOrders, handleClickTypeOrdersButton }: { orderRecords: OrdersRecord[], isSelectedTypeOrders: any, handleClickTypeOrdersButton: any }) {

    return (
        <>
            <OrdersHederActions isSelectedTypeOrders={isSelectedTypeOrders} handleClickTypeOrdersButton={handleClickTypeOrdersButton} />
