...
export default function Auctions() {
    ...
    return (
        <AuctionsTemplate auctionRecords={[]} isSelectedAuctionPortal={isSelectedAuctionPortal} handleClickTypeAuctionPortalButton={handleClickTypeAuctionPortalButton} isSelectedTypeAuctions={isSelectedTypeAuctions} handleClickTypeAuctionsButton={handleClickTypeAuctionsButton} />
    );
}