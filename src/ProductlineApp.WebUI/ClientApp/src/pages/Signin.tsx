                    ...
                    <div className='signinSection'>
                        ...
                        <form>
                            <div className="avatarField">
                                <img className="avatarUploadedImage" src={image === null ? UserImage : URL.createObjectURL(image)} ></img>
                                <div className="file">
                                    <input type="file" accept="image/*" id="avatarPhoto" name="avatarPhoto" className="avatarPhotoInput" onChange={showImage} />
                            ...
                            <label htmlFor="repeatPassword" className="repeatPasswordLabel">Powtórz Hasło</label>
                            <div className="repeatPasswordField">
                                <input type={!isPasswordVisible ? "password" : "text"} id="repeatPassword" name="repeatPassword" placeholder="Podaj hasło" className="repeatPasswordInput"></input>
                                <img className="repeatImageEye" src={isPasswordVisible ? EyeVisible : EyeInvisible} onClick={showPassword} />
                            </div>
