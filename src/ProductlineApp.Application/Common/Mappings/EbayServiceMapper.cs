...
public class EbayServiceMapper : Profile
{
    public EbayServiceMapper()
    {
        ...
        // this.CreateMap<ProductDtoRequest, EbayCreateOrReplaceInventoryRequest>()
        //     .ForMember(dest => dest.Product, opt => opt.MapFrom(src =>
        //         new EbayCreateOrReplaceInventoryRequest.EbayProduct
        //         {
        //             Title = src.Name,
        //             Description = src.Description,
        //             ImageUrls = src.ImageUrls.ToList(),
        ...
        //         new EbayCreateOrReplaceInventoryRequest.AvailabilityObject
        //         {
        //             ShipToLocationAvailability = new EbayCreateOrReplaceInventoryRequest.ShipToLocationAvailability
        //             {
        //                 Quantity = src.Quantity,
